...
const Projects = () => {
  ...
  return (
    <section id="projects" className="bg-[#0D1117] text-white min-h-screen flex flex-col justify-center">
      <div className="container px-4 mx-auto max-w-5xl">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto w-full">
          {projects.map((project) => (
            <a
              ...
              className="card bg-[#161B22] shadow-xl hover:scale-105 transition-transform duration-300 ease-in-out group relative overflow-hidden w-full"
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/70 to-black/90 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <div className="text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    <FaExternalLinkAlt className="text-4xl text-white mb-2 mx-auto animate-bounce" />
                  </div>
                </div>
              </div>
