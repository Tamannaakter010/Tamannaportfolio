const Services = () => {
    return (
        <div className="bg-[#0D1117] min-h-screen p-4 sm:p-8 text-white flex flex-col items-center max-w-full overflow-x-hidden">
            ...
            <div className="flex flex-col gap-6 mt-10 w-full">
                {/* Website Development */}
                <div className="bg-[#161B22] rounded-lg shadow-lg p-4 w-full max-w-md mx-auto" data-aos="fade-right">
                    <div className="flex items-center gap-3 justify-center">
                        <span className="text-xl">💻</span>
                        <h3 className="text-sm font-semibold">Website Development</h3>
                    </div>
                    <p className="text-gray-400 mt-2 text-xs sm:text-sm text-center break-words">
                ...
                {/* Web Design */}
                <div className="bg-[#161B22] rounded-lg shadow-lg p-4 w-full max-w-md mx-auto" data-aos="fade-left">
                    <div className="flex items-center gap-3 justify-center">
                ...
                {/* Machine Learning */}
                <div className="bg-[#161B22] rounded-lg shadow-lg p-4 w-full max-w-md mx-auto" data-aos="fade-up">
                    <div className="flex items-center gap-3 justify-center">
                        <span className="text-xl">🔵</span>
